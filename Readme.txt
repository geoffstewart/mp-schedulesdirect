This plugin was initially developed by some folks here:  
...
We intend to keep the plugin current with versions of MediaPortal, 
fix the occasional bug and time-permitting, add features.
