  ...
  public class EpgListingsImporter : IDisposable
  {
    ...
    public int ImportPrograms(int delay)
    {
      ...
      foreach (SchedulesDirect.SoapEntities.TVSchedule tvSchedule in _results.Data.Schedules.List)
      {
        ...
        //Program mpProgram = new Program(idTvChannel, localStartTime, localEndTime, zTitle, description.ToString(), zGenre, false, tvProgram.OriginalAirDate.Date, zSeriesNum, zEpisodeNum, mpStarRating, zClassification);
        //mpProgram.Persist();
        //stats._iPrograms++;
        foreach (Channel pCh in channelIdList)
        {
          Program mpProgram = new Program(pCh.IdChannel,
                                          localStartTime,
                                          localEndTime,
                                          zTitle,
                                          ...
                                          tvProgram.OriginalAirDate.Date,
                                          zSeriesNum,
                                          zEpisodeNum,
                                          zEpisode,
                                          zEpisodePart,
